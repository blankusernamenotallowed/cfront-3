...
/* < /c/Users/Diana/pg/cfront-3/demo/overload.C > */
...
extern struct __mptr* __ptbl_vec___c_Users_Diana_pg_cfront_3_demo_overload_C_[];
...
printf ( (const char *)"n = %d\n", __1n ) ;
printf ( (const char *)"max(3,7)=%d  max(2.5,1.5)=%g\n", maxv__FiT1 ( 3 , 7 ) , maxv__FdT1 ( 2.5 ,
1.5 ) ) ;
return 0 ;
}
} 
