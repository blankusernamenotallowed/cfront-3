...
extern struct __mptr* __ptbl_vec__zoo_C_[];
...
)(sizeof (struct Animal))) ))?( (__0__X3 -> __vptr__6Animal = (struct __mptr *) __ptbl_vec__zoo_C_[0]), (__0__X3 -> legs__6Animal = 4 )) :0 ), __0__X3 ) ) ),
(__0__X9 -> __vptr__6Animal = (struct __mptr *) __ptbl_vec__zoo_C_[1])) :0 ), __0__X9 ) ) ;
...
)(sizeof (struct Animal))) ))?( (__0__X5 -> __vptr__6Animal = (struct __mptr *) __ptbl_vec__zoo_C_[0]), (__0__X5 -> legs__6Animal = 2 )) :0 ), __0__X5 ) ) ),
(__0__X10 -> __vptr__6Animal = (struct __mptr *) __ptbl_vec__zoo_C_[2])) :0 ), __0__X10 ) ) ;
{ { int __1i ;
...
struct Vec2 __0__X__V600azwmaaibmo ;
...
(__2__X8 = ((& __1a )-> y__4Vec2 + __2__X11 . y__4Vec2 )), ( (( ((& __0__X__V600azwmaaibmo )-> x__4Vec2 = __2__X7 ), ((& __0__X__V600azwmaaibmo )->
y__4Vec2 = __2__X8 )) ), (& __0__X__V600azwmaaibmo )) ) ) , __0__X__V600azwmaaibmo ) ) ) ;
...
struct __mptr __vtbl__4Bird__zoo_C[] = {0,0,0,
...
struct __mptr __vtbl__3Dog__zoo_C[] = {0,0,0,
0,0,(__vptp)__dt__3DogFv ,
0,0,(__vptp)sound__3DogFv ,
0,0,(__vptp)kind__3DogFv ,
0,0,0};
struct __mptr __vtbl__6Animal__zoo_C[] = {0,0,0,
...
int __0__free ){ 
if (__0this ){ __0this -> __vptr__6Animal = (struct __mptr *) __ptbl_vec__zoo_C_[2];

if (__0this ){ ( ((((struct Animal *)__0this ))?(((void )( ((((struct Animal *)__0this ))-> __vptr__6Animal = (struct __mptr *) __ptbl_vec__zoo_C_[0]), ((((struct Animal *)__0this ))?(((void )(((void
)0 )))):(((void )0 )))) )):(((void )0 )))) ;
...
int __0__free ){ 
if (__0this ){ __0this -> __vptr__6Animal = (struct __mptr *) __ptbl_vec__zoo_C_[1];
...
int __0__free ){ 
if (__0this ){ 
__0this -> __vptr__6Animal = (struct __mptr *) __ptbl_vec__zoo_C_[0];

if (__0this )if (__0__free & 1)__dl__FPv ( (void *)__0this ) ;
} 
}
struct __mptr* __ptbl_vec__zoo_C_[] = {
__vtbl__6Animal__zoo_C,
__vtbl__3Dog__zoo_C,
__vtbl__4Bird__zoo_C,
